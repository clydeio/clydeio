...
module.exports.log = function(options) {
  ...
  // NOTE: If log is initialized return the instance.
  // This allows to call 'log()' without options from other modules once
  // initialized with options.
  if(!options) {
    if(instance) {
      return instance;
    } else {
      throw new Error("Options required first time clyde log is initialized !!!");
    }
  }
