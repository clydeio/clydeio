...
/**
 * @classdesc
 * Barkley is the chief manager for Clyde's configuration. It handles all the
 * concepts related with configuration: providers, filters, resources, etc.
 *
 * This is a memory implementation of Barkley, **only suitable use for testing and
 * not for production**.
 *
