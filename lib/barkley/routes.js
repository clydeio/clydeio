...
var NO_FILTER_PROVIDER_FOUND_MSG = "No resource found for PROVIDER_ID='%s' and FILTER_ID='%s'.";
var NO_FILTER_RESOURCE_FOUND_MSG = "No resource found for RESOURCE_ID='%s' and FILTER_ID='%s'.";
...
function postProviderResource(req, res, next) {
  var idProvider = req.params.idProvider;
  var props = req.body;
...
function putProviderResource(req, res, next) {
  var idProvider = req.params.idProvider;
  var idResource = req.params.idResource;
  var props = req.body;
...
function postProviderFilter(req, res, next) {
  var idProvider = req.params.idProvider;
  var idFilter = req.params.idFilter;
  var type = req.params.type;
  // Add filter
  barkley.addProviderFilter(idProvider, idFilter, type, function(err, filter) {
    if (err) {
      if (err instanceof Errors.NoEntityFound) {
        return next(new HttpError(404, util.format(NO_FILTER_PROVIDER_FOUND_MSG, idProvider, idFilter)));
      }
...
function deleteProviderFilter(req, res, next) {
  var idProvider = req.params.idProvider;
  var idFilter = req.params.idFilter;
  var type = req.params.type;
  // Delete resource
  barkley.deleteProviderFilter(idProvider, idFilter, type, function(err, resource) {
    if (err) {
      if (err instanceof Errors.NoEntityFound) {
        return next(new HttpError(404, util.format(NO_FILTER_PROVIDER_FOUND_MSG, idProvider, idFilter)));
      }
...
function postResourceFilter(req, res, next) {
  var idProvider = req.params.idProvider;
  var idResource = req.params.idResource;
  var idFilter = req.params.idFilter;
  var type = req.params.type;
  // Add filter
  barkley.addResourceFilter(idProvider, idResource, idFilter, type, function(err, filter) {
    if (err) {
      if (err instanceof Errors.NoEntityFound) {
        return next(new HttpError(404, util.format(NO_FILTER_RESOURCE_FOUND_MSG, idProvider, idFilter)));
      }
...
function deleteResourceFilter(req, res, next) {
  var idProvider = req.params.idProvider;
  var idResource = req.params.idResource;
  var idFilter = req.params.idFilter;
  var type = req.params.type;
  // Delete resource
  barkley.deleteResourceFilter(idProvider, idResource, idFilter, type, function(err, resource) {
    if (err) {
      if (err instanceof Errors.NoEntityFound) {
        return next(new HttpError(404, util.format(NO_FILTER_RESOURCE_FOUND_MSG, idProvider, idFilter)));
      }
...
providersRoutes.post("/providers/:idProvider/:type(prefilters|postfilters)/:idFilter", postProviderFilter);
providersRoutes.delete("/providers/:idProvider/:type(prefilters|postfilters)/:idFilter", deleteProviderFilter);
...
providersRoutes.post("/providers/:idProvider/resources", postProviderResource);
providersRoutes.put("/providers/:idProvider/resources/:idResource", putProviderResource);
...
providersRoutes.post("/providers/:idProvider/resources/:idResource/:type(prefilters|postfilters)/:idFilter", postResourceFilter);
providersRoutes.delete("/providers/:idProvider/resources/:idResource/:type(prefilters|postfilters)/:idFilter", deleteResourceFilter);
