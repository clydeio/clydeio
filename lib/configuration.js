 ...
 *
 * @public
 * @param  {string} path Path to be used for searching modules
 * @return {none}
 */
function base(path) {
  basePath = path;
 ...
 * @return {Array<object>} Array with filter's configuration plus a middleware
 ...
 * @return {Array<object>} Array with provider's configuration plus a middleware
 ...
 * @return {object} configuration with middlewares loaded.
 */
