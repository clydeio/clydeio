...
function listFilterConsumerConfigs(req, res, next) {
  var idFilter = req.params.idFilter;
  butler.findFilterConsumerConfigs(idFilter, function(err, configs) {
    if (err) {
      next(err);
    }
    res.json(configs);
...
function getFilterConsumerConfig(req, res, next) {

}

function addFilterConsumerConfig(req, res, next) {

}

function updateFilterConsumerConfig(req, res, next) {

}

function deleteFilterConsumerConfig(req, res, next) {
...
filtersRoutes.get("/filters/:idFilter/consumerconfig/:idConsumer", getFilterConsumerConfig);
filtersRoutes.post("/filters/:idFilter/consumerconfig/:idConsumer", addFilterConsumerConfig);
filtersRoutes.put("/filters/:idFilter/consumerconfig/:idConsumer", updateFilterConsumerConfig);
filtersRoutes.delete("/filters/:idFilter/consumerconfig/:idConsumer", deleteFilterConsumerConfig);
