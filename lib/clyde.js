...
// Filters will be loaded from the parent folder
 ...
 * NOTE: Function context is a Clyde instance.
 *
 * @private
 * @param  {object} provider Provider configuration
 * @returns {void}
 */
function registerProviderMiddleware(provider) {
...
Clyde.prototype.middleware = function() {
  ...
  for (index = 0; index < num; index++) {
    registerProviderMiddleware.call(this, middlewares.providers[index]);
  }
